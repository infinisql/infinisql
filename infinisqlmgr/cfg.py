...
class node:
    ...
    def configure(self, config, section):
        self.username = config._get(section, 'username')
        self.ssh_key = config._get(section, 'sshkey')
        self.ssh = config._get(section, 'ssh')
        self.infinisqld = config._get(section, 'infinisqld')
        self.logfile = config._get(section, 'logfile')
        self.global_admin_password = config._get(section, 'globaladminpassword')
        self.cfg_host_port = config._get(section, 'cfghostport')
        self.cfg_remote_host_port = config._get(section, 'cfgremotehostport')
        self.mgmt_host = config._get(section, 'mgmthost')
        self.listen_host = config._get(section, 'listenhost')
        self.listen_port = config._get(section, 'listenport')
        self.ib_gateway_host_port = config._get(section, 'ibgatewayhostport')
        ...
        self.pg_host = config._get(section, 'pghost')
        self.pg_port = config._get(section, 'pgport')
