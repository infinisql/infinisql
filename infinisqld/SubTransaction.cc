...
{
#ifdef PROFILE
  subtransactionpoints = new PROFILERENGINE[20];
  rid = enginePtr->rid++;
  subtransactionpoints[0] = enginePtr->inboundProfile[0];
  subtransactionpoints[1] = enginePtr->inboundProfile[1];
  subtransactionpointcount=2;
