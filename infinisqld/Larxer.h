...
public:
	...
	/**
	 * @brief data populating pre- Ast stack. SQL token and associated value.
	 *
	 */
	...
	void consumeDelete();
	/**
	 * @brief extract CREATE query from stack
	 *
	 */
	void consumeCreate();
	/**
	 * @brief extract DROP query from stack
	 *
	 */
	void consumeDrop();
	/**
	 * @brief extract ALTER query from stack
	 *
	 */
	void consumeAlter();
	/**
